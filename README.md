...
ETL-процесс для автоматического сбора, обработки и анализа данных об учебных активностях студентов обучающей системы (LMS) крупного онлайн-университета. Система регулярно обрабатывает данные
тысяч студентов и предоставляет необходимую отчётность.
...
Регулярно получать данные о попытках решения задач студентами через REST API корпоративного клиента.
...
<img width="734" height="500" alt="image" src="https://github.com/user-attachments/assets/009b836c-deed-4832-a0f7-94797466e3e3" />
