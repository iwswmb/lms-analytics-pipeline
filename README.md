...
#### *С 24.02.2026 сервер отключен, поэтому дашборд можно посмотреть только в виде скринов*
### Ссылка на Дашборд:
...
[↗️ Отчет со статистикой](https://docs.google.com/spreadsheets/d/1QkvUGpBwJa_0MeM0hCb1J0giXBCnxZmyYLoJH-FPO7o/edit?usp=sharing)
*Нажмите правой кнопкой мыши → "Открыть ссылку в новой вкладке"*
...
<img width="1252" height="460" alt="logs" src="https://github.com/user-attachments/assets/b1271afd-30b7-40a9-9b0b-982aaaed3cb5" />
 <br>
 <br>
...
<img width="654" height="500" alt="email" src="https://github.com/user-attachments/assets/5ae71e5c-ba93-4a86-9ccd-f84191c50729" />
<br>
<br>
...
DASHBOARD_URL=ваша_ссылка_на_дашборд
```
